...
echo [1/3] Rilevamento indirizzo IP locale della macchina...
...
echo [2/3] Avvio di Supabase locale in Docker...
...
echo ===============================================================================
echo.
echo [3/3] Avvio di Next.js Dev Server in una finestra indipendente...
echo.
